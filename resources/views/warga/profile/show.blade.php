    ...
    <div class="profile-card">
        ...
        <form id="profile-form" class="profile-form" action="{{ route('profile.update') }}" method="POST">
            ...
            <div class="form-group">
                ...
                <div class="form-item"><label for="email">Email *</label><input type="text" id="email" name="email" value="{{ old('email', $user->email) }}" onkeydown="allowNumbersOnly(event)" required>@error('email') <div class="alert-danger">{{ $message }}</div> @enderror</div>
